...
test('ourJavaScript__is_the_eleven_static_files_and_two_sort_plugins', () => {
  ...
  assert.deepStrictEqual(ours, [
    ...
    'netdisco-portcontrol.js', 'netdisco-request.js', 'netdisco-swagger.js', 'netdisco-tables.js',
    'netdisco-toast.js', 'netdisco-typeahead.js', 'netdisco.js', 'portsort.js', 'versionsort.js',
  ]);
});
